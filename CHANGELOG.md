...
5. Create a new /api/v1/jobs/unpaid endpoint to GET All the Get all the unpaid jobs for a user (**_either_** a client or contractor), for **_active contracts only_**.
